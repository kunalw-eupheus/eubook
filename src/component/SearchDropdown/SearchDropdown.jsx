...
export default function BasicSelect(
  { data, Name, handleOrderProcessingForm, index },
  label
) {
  const defaultProps = {
    options: data,
  ...
  const handleDropDown = (value, type) => {
    ...
    if (type === "select_booktype") {
      console.log(value, type, index);
      handleOrderProcessingForm(value, type, index);
    }
    if (type === "select_seriessubject") {
      console.log(value, type);
      handleOrderProcessingForm(value, type);
    }
  };
